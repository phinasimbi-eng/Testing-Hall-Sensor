...
#define IIC_SCL_RESET() 			do{GPIO_PBC_Pins_Reset(IIC_SCL_PORT,IIC_SCL_PIN);}while(0);
#define IIC_SDA_SET()					do{GPIO_Pins_Set(IIC_SDA_PORT,IIC_SDA_PIN);}while(0);
#define IIC_SDA_RESET()				do{GPIO_PBC_Pins_Reset(IIC_SDA_PORT,IIC_SDA_PIN);}while(0);
